...
<html>
<head>
   <title>Login Form by_Renitha Erdiana</title>
   <script type="text/javascript">
// Fungsi check digunakan untuk mengecheck kosong atau tidaknya inputan username dan password
function check()
{
    if(form1.user.value == "")
    {
...
<div id="apDiv1">
  ...
  <br>
    <div id="apDiv3">
     ...
     <span class="style3">&copy;Copy Right By_Renitha Erdiana</span><br>
    </div>
  </div>
</form>
<div id="apDiv4">
...
{   
    if (($_POST['user']=='Renitha')AND($_POST['pass']=='renitha'))
    {
