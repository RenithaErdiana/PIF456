...
$objPHPExcel->getActiveSheet()->setCellValue('E2', "PEMERINTAH KOTA TRENGGALEK");
$objPHPExcel->getActiveSheet()->mergeCells('E3:M3');
$objPHPExcel->getActiveSheet()->setCellValue('E3', "DINAS PENDIDIKAN");
$objPHPExcel->getActiveSheet()->mergeCells('E4:M4');
$objPHPExcel->getActiveSheet()->setCellValue('E4', "SMAN 1 KARANGAN");
$objPHPExcel->getActiveSheet()->mergeCells('E5:M5');
$objPHPExcel->getActiveSheet()->setCellValue('E5', "Jl. Trenggalek Ponorogo Km.3");
$objPHPExcel->getActiveSheet()->mergeCells('E6:M6');
$objPHPExcel->getActiveSheet()->setCellValue('E6', "REKAPITULASI DATA SISWA TAHUN 2013");
